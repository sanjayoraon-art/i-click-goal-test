      ...
      <div className="max-w-3xl mx-auto">
        <Card className="bg-card/80 backdrop-blur-sm shadow-lg rounded-2xl border">
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <p>
              Our Click Games website ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and disclose information about you when you use our website.
            </p>

            <h2 className="text-xl font-semibold text-foreground pt-4">Information We Collect</h2>
            <p>
              We do not collect any personal information from you. Your test results are processed in your browser and are not stored on our servers. We may use anonymous usage data through analytics services to understand how our website is used and to improve it.
            </p>
